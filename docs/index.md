...
hero:
  ...
  tagline: "Системное саморазвитие, методы, инструменты и мышление — от первых шагов до проактивного уровня."

features:
  - title: Руководство 1 — Системное саморазвитие
    details: "Культура ученика, мировоззрение, 10 разделов. Ступени 1–5."
    link: /ru/personal-design/1-1-systemic-self-development/
    linkText: Открыть руководство
  - title: Руководство 2 — Методы саморазвития
    details: "M001–M008: защищённый слот, учёт времени, чтение, мышление письмом, досуг, окружение, стратегирование, планирование. Ступени 2–5."
