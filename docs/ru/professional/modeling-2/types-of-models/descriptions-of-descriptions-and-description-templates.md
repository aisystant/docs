...
Что такое *«описание описания»*, каков тип этого объекта? Ничего сложного: *описание описания* (*инструкция к описанию)*, которое помогает его интерпретировать – это тоже «**\*описание**\*», поэтому оно должно соответствовать всем требованиям, которые мы выдвигаем к описаниям.
...
А содержание инструкции к описанию – это **\*то, как читать описание**\*. То есть *инструкция к описанию* описывает исходное описание во вполне определённом смысле: она определяет тот **\*язык, на котором написано исходное описание**.\*
...
Приставку **\*мета-**\* вы, может быть, встречали в IT. Там есть понятие *метаданные* – *данные о данных*, в точности как у нас, описание описаний.
