...
Но с помощью триплета ([https://en.wikipedia.org/wiki/Semantic\*triple](https://en.wikipedia.org/wiki/Semantic*triple)) может быть выражено вообще любое отношение между двумя объектами:
