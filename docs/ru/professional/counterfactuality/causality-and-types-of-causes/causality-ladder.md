...
Например*, либо* человек прошел стажировку по рациональной работе и по рекомендации отсюда прочёл книжку “The Book of Why", *либо* он прочёл блог «Лабораторный журнал» [https://ailev.livejournal.com/](https://ailev.livejournal.com/) и увидел там рекомендации пройти стажировку и прочитать книжку. Но может быть, он просто любознателен, обнаружил и стажировку, и книжку, не зная, что в МИМ рекомендуют эту книжку прочесть.
