...
* *Объяснение* (или можно сказать **\*объяснительная модель**\*) — это такое описание, в котором выделены особые отношения между выделенными объектами *— причинно-следственные связи*.
