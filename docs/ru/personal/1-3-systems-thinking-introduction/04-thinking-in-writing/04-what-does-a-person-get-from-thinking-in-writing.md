---
title: "4.4. Что получает человек от мышления письмом"
order: 4
type: text
---


# 4.4. Что получает человек от мышления письмом
...
[^134]: Ссылка на первый семестр программы «Организационное развитие» на сайте МИМ: https://system-school.ru/1-org-dev

[^135]: Смотрите таблицу по неудовлетворенностям. Их важно заполнять, чтобы за счет мышления письмом обратить внимание на причину своих жизненных беспокойств и выработать осознанное решение по изменению своей жизни. Ведь, прежде чем что-то менять, необходимо хорошо разобраться в себе. И практика мышления письмом отличный инструмент для этого. Поэтому заполняйте таблицы по неудовлетворенностям.
