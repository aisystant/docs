---
title: "4.16. Как освоить практику мышления письмом. Третий и четвертый этапы — «Навык» и «Мастерство»"
order: 16
type: text
---


# 4.16. Как освоить практику мышления письмом. Третий и четвертый этапы — «Навык» и «Мастерство»


При первом знакомстве с практикой этот подраздел можно пропустить.

На третьем этапе вы реализуете практику мышления письмом при каждом удобном случае, и даже не понимаете, как можно размышлять без этого. Вы реализуете мышление письмом не потому, что надо, а потому что не понимаете как же без этого исполнять роль ученика[^179]. С вами случилась метанойя. На этом этапе вы обращаете внимание на:
