---
title: "8.20. Как практика стратегирования связана с другими практиками саморазвития"
order: 20
type: text
---


# 8.20. Как практика стратегирования связана с другими практиками саморазвития
...
[^324]: Например, вы приняли стратегическое решение реализовывать два приоритетных проекта в течение двух ближайших месяцев. На оба проекта вы выделяете 200 часов, понимая из практики инвестирования и учета времени, что у вас в месяце в среднем 220 часов, а за 2 месяца — 440 часов. Поэтому вы вполне можете позволить себе эти 2 приоритетных проекта, а остальное время у вас будет расходоваться на текущую работу и прочие дела.
