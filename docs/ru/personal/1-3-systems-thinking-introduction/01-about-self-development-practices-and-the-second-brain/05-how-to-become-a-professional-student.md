...
Практики саморазвития отличают ученика, который относится к обучению как профессионал, от того, кто учится, не обращая внимания на лучшие практики ученика[^16]. В руководстве "Практики саморазвития" включены несколько практик[^17], которые помогут вам **стать профессиональным учеником или мастером саморазвития**.
...
[^14]: Когда речь идет о ментальных практиках, эти технологии образуют второй мозг.
...
[^16]: Того, кто в учебе как бы "плавает по собачьи" вместо того, чтобы вложить время в изучение более эффективной практики кроля.
