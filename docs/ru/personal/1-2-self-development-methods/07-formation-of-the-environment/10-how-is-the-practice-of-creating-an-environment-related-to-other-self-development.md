---
title: "7.10. Как метод формирования окружения связана с другими методами саморазвития"
order: 10
type: text
---


# 7.10. Как метод формирования окружения связана с другими методами саморазвития


В процессе изучения метода формирования окружения задействуется **систематическое медленное чтение и мышление письмом**. Например, необходимо формировать заметки по своим мыслям и составлять следующие рабочие продукты:
