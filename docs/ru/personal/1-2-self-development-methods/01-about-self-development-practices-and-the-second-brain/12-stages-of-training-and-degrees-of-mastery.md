---
title: "1.12. Стадии обучения и степени мастерства"
order: 12
type: text
---


# 1.12. Стадии обучения и степени мастерства
...
**Стадии обучения** — это определенный отрезок времени, в котором выполняются работы для постановки мастерства (развития мастерства). Работы осуществляются по конкретным методам (методам)[^30]. В свою очередь, **степень мастерства** — это качество владения изучаемым методом. Например, можно выделить стадию "Пропитка", без которой невозможно вкладывать инвестиционное время в освоение нового. А степень владения "Умение" означает способность применять конкретный метод и даже делать это систематично, хотя будет невысокое качество рабочих продуктов или медленная скорость работы.
...
Опишем, как развивается прогресс во владении любым методом в таблице "Связь степени мастерства и стадий обучения". В ней мы выделим 4 этапа постановки мастерства (по названиям 4 степени мастерства). Каждый этап у конкретного человека будет занимать разное время, поэтому мы не будем приводить точные временные периоды. Но каждому стажеру желательно отслеживать этапность в личном понедельном плане стажировки.

В таблице показана **приоритетность работ** по каждой стадии на всех этапах постановки мастерства. Выделенная приоритетность позволит вам лучше управлять своим вниманием (осознанное обучение) на разных этапах. Данная таблица будет использоваться для описания этапов постановки мастерства, а также для формирования личного плана обучения по каждом методе.


## Связь степеней мастерства и стадий о учения\*
...
[^30]: Например, мне нужно совершить работу — проплыть 1 км. Я эту работу выполняю методом плавания кролем.

[^31]: Данный план работ вы сможете адаптировать под себя.
