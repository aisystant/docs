...
Выделим **4 этапа постановки мастерства**, которые будут совпадать по названию с 4 степенями мастерства: «Объяснение», «Умение», «Навык», «Мастерство». При этом мы будем разделять мастерство владения конкретной практикой и мастерство владения всеми практиками саморазвития одновременно[^39]. Степени «Объяснения» и «Умения» по мастерству саморазвития достигаются преимущественно за счет соответственно «Объяснения» и «Умения» по каждой из 8 изучаемых практик саморазвития[^40]. А степени «Навык» и «Мастерство» по мастерству саморазвития будут связаны с применением всех практик саморазвития вместе.
...
Сначала у человека возникает **любопытство или острая необходимость** (неудовлетворенность), потом он выдвигает гипотезу о том, что нужно сделать то-то, и вот для этого необходимо новое мастерство, а потому он готов начать изучение определенной практики[^41]. По итогу прохождения данного этапа у человека появляется степень "Объяснение", на котором он может:
...
- **Пропитка**. Объясняете себе почему вы готовы инвестировать время и средства в эту практику, чтобы первоначальное желание переросло в сильную мотивацию на длительное обучение (формирование высокой агентности[^42]). Например, сформируйте окружение, которое будет удерживать ваше внимание на данной практике и мотивировать. Это могут быть подписки на сокурсников и мастеров МИМ, а также внешних людей и каналы.
- **Изучение теории**:
...
- выберите любую технологию для данной практики[^46];
...
- для формирования мастерства по некоторым практикам саморазвития **мы рекомендуем пройти нашу основную программу**[^55], поскольку там вы получите фундаментальные знания (мета-мета-модели). Они помогут вам увидеть недоступные другим детали и подводные камни каждой практики. Чтобы стать мастером в мышлении письмом и проговариванием будет необходимо закончить первый семестр основной программы, а мастером в стратегировании и планировании можно стать только после прохождения второго семестра основной программы.
- мастерство растет не столько за счет усиленных тренировок (хотя они тоже важны), сколько **за счет обучения других**, что позволяет лучше понимать практику и находить улучшения. Поэтому обратите внимание на время, которое вы сможете выделить, чтобы передавать опыт другим[^56].
...
[^43]: При изучении каждой практики саморазвития вы уже начинаете применять все остальные практики. Например, при прохождении практики «систематическое медленное чтение», вы будете изучать соответствующий раздел руководства с помощью медленного чтения.
...
[^54]: То есть не можете не учиться, не можете не исполнять данные практики.

[^55]: Пример смотрите в подразделе «Как освоить практику мышления проговариванием. Четвертый этап — мастерство».
...
[^57]: Не бояться нести ответственность «за тех, кого приучили». Не бояться вести за собой людей, быть сильными и подавать пример мастерства. Лидер ведет за собой, в первую очередь, за счет своего примера исполнения тех практик, которые он проповедует.
