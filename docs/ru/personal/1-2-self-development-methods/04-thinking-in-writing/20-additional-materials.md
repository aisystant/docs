...
Написать заготовку по такой структуре довольно просто. В каждом абзаце будет достаточно написать 3--5 предложений. С этим сможет справиться даже новичок в методе мышления письмом. В этом вам помогут заметки, которые вы решите собирать каждый день по итогам систематического медленного чтения. Намного легче писать любой пост не с чистого листа, а уже имея какие-то подготовленные за неделю мысли.
...
После окончания работы обязательно опубликуйте заготовку в блоге, независимо от его качества. Вы не журналист, и не обязаны владеть методом красивого письма. Ваша заготовка совершенно точно уникальная и будет интересна сокурсникам и будущим стажерам, которые вдохновляются первыми публикациями людей, которые до этого не писали. Ваш опыт будет интересен другим, так устроены люди.
...
Если вы за время стажировки напишете 9 заготовок по данной структуре, то вы не только осознаете изученные понятия, но также сможете сделать большой шаг к тому, чтобы мышление письмом стало вашей главным методом размышлений. Не теряйте времени, начинайте практиковать мышление письмом сразу же после прочтения этого раздела.
...
Мыслительный резонанс используется в методах систематического медленного чтения и мышления письмом.
...
[^182]: https://aisystant.system-school.ru/lk/#/course/ontologics-sobr/2024-09-07T1140/41510
