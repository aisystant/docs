...
[^135]: Смотрите таблицу по неудовлетворенностям. Их важно заполнять, чтобы за счет мышления письмом обратить внимание на причину своих жизненных беспокойств и выработать осознанное решение по изменению своей жизни. Ведь, прежде чем что-то менять, необходимо хорошо разобраться в себе. И метод мышления письмом отличный инструмент для этого. Поэтому заполняйте таблицы по неудовлетворенностям.
