...
Мастер инвестирования и учета времени, как и любой другой человек, каждый день что-то делает, но при этом для некоторых **важных для него действий он использует практику инвестирования и учета времени**.
...
[^92]: В практике планирования вы узнаете, что есть постоянные работы и отдельные работы, а также при необходимости можно ввести временные работы.
