---
title: "2.15. Как освоить метод инвестирования и учета времени. Третий этап — «Навык»"
order: 15
type: text
---


# 2.15. Как освоить метод инвестирования и учета времени. Третий этап — «Навык»


При первом знакомстве с методом этот подраздел можно пропустить.

На третьем этапе **необходимо поднимать осознанность в реализации метода инвестирование и учет времени**, а также увеличивать количественные показатели, обращая внимание на выполнение его принципов. Для этого можно сделать следующее:

1. **Увеличить количество проектов**, по которым ведется учет времени. Причем вы можете разделять инвестиционные проекты и другие, чтобы видеть статистику.
2. Постепенно увеличивать **цель времени фокусировки на день**. Вы начали с двух часов, и, если все идет хорошо, можете поднимать этот показатель на 1 час в день. Но как только показатель «Процент выполнения цели» будет менее 50%, повышение необходимо прекратить. На этапе «Навык» вполне достаточно иметь цель времени фокусировки 5 часов в день с процентом выполнения цели 90% соответственно.
3. Найти разные варианты по **длительности помидорки**. Вы начинали с помидорки продолжительностью 25 минут, а на этапе «Навык» желательно увеличить это время, как минимум, для систематического медленного чтения и мышления письмом до 60 минут.
...
6. **Станьте инструктором** по данному методу. Как минимум, заинтересуйте культурой инвестирования и учета времени своих близких.
