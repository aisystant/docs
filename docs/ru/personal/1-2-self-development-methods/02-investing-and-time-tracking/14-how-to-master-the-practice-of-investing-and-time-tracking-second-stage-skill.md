...
3. **До включения трекера Помодоро тренируйтесь обязательно продумывать ситуацию**, что вы сейчас в рамках роли ученика будете реализовывать такой-то метод, чтобы получить такой-то результат (рабочий продукт).
