---
title: "8.25. Как освоить метод стратегирования. Третий этап — «Навык»"
order: 25
type: text
---


# 8.25. Как освоить метод стратегирования. Третий этап — «Навык»


При первом знакомстве с методом этот подраздел можно пропустить.

На третьем этапе вы реализуете метод стратегирования легко и непринужденно. Вы также не понимаете, как можно было без нее жить. С вами случилась метанойя. На этом этапе вы обращаете внимание на:
...
Кроме того, обратите внимание на все рабочие продукты по методу стратегирования (смотри одноименный подраздел). Например, список моих методов может быть использован для построения личной образовательной траектории.
...
На этом этапе можно замечать многие тонкости в реализации метода стратегирования. Например, при старте каждого нового приоритетного проекта будет необходимо продумывать окружение, в котором вы окажетесь и как вы можете его изменить, чтобы оно вас мотивировало и развивало.

Навык стратегирования достигается за счет постоянной реализации метода. Например, не игнорируйте комментарии сокурсникам или членам клуба МИМ, поскольку так вы лишний раз практикуетесь, обращаете внимание на понятия и размышляете на заданную тему.
...
- 2024 — текущий год
  ...
  - 4 квартал *(заполняется перед стартом квартала).*
    ...
    - *Поработать с методами саморазвития (чек-лист)*

      - *Определить методы досуга на 4 квартал (по необходимости)*
