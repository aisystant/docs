---
title: "5.16. Как освоить практику мышления проговариванием. Четвертый этап — «Мастерство»"
order: 16
type: text
---


# 5.16. Как освоить практику мышления проговариванием. Четвертый этап — «Мастерство»
...
Для того, чтобы правильно использовать данную практику, необходимо понимать так называемую «машинку типов»[^197], чтобы не только не совершать ошибок самому, но и уметь быстро выявлять такие онтологические ошибки у других. Ведь на четвертом этапе мастерства вы начинаете учить окружающих.
