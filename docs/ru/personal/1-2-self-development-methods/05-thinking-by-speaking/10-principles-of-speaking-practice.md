---
title: "5.10. Принципы метода проговаривания"
order: 10
type: text
---


# 5.10. Принципы метода проговаривания


Мастерство мышления проговариванием развивается за счет метода мышления проговариванием, который базируется на следующих принципах:

1. **Разговаривать умеют все, но мышлению проговариванием нужно учиться**. Такой вид мышления не так прост, как кажется. Используя его, необходимо обращать внимание на понятия и принципы теории, роли и рабочие продукты, системы и проекты. Наиболее сильный эффект от этого метода проявится после прохождения руководства «Рациональная работа», на котором обращают внимание на понятийное наведение внимания.
...
3. **Разделяйте желание поговорить и мышление проговариванием**. Приятное общение не является главным принципом мышления проговариванием. Основной результат мышления проговариванием — проговоренные основные понятия и понимание их связи между собой, чтобы можно было встроить данные понятия в свое мировоззрение.
