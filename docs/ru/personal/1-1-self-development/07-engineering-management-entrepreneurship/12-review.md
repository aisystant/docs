...
id: "1.1.07.12"
type: text
title: "7.12. Вопросы для повторения и дальнейшего изучения"
order: 12
---


# 7.12. Вопросы для повторения и дальнейшего изучения
...
5. Почему рекомендуется табуировать понятие «предприниматель», «менеджер», «инженер» в конкретном проекте?
