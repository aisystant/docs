...
id: "1.1.05.14"
type: text
title: "5.14. Вопросы для повторения и дальнейшего изучения"
order: 14
---


# 5.14. Вопросы для повторения и дальнейшего изучения
...
3. Какой моделью предлагается связывать психологию и системное мышление? Продуктивно ли исключительно «разбираться в себе» и как в учебнике предлагается устранять личные неудовлетворённости?

4. Достаточно ли просто один раз описать неудовлетворённости? Как вы поняли метод нащупывания и в чём его суть?

5. Чем отличаются неудовлетворённости от ролевых интересов? Можно ли сказать, что у Ивана есть ролевой интерес к автомобилю, а у инженера есть личная неудовлетворённость?
...
9. Назовите стадии и методы жизнедеятельности бесконечно-развивающегося создателя? Зачем выделяются данные стадии? Какие методы (практики) вы реализуете?
