...
id: "1.1.02.14"
type: text
title: "2.14. Вопросы для повторения и дальнейшего изучения"
order: 14
---


# 2.14. Вопросы для повторения и дальнейшего изучения
...
8. Для чего нужны три модели обучения, приведённые в данной главе? Что можно обсуждать по каждой из них?
...
10. В чём суть принципа отрицательной полезности труда? Какие три фактора помогают человеку принимать решение о том, чтобы посвятить время и другие ресурсы будущему?
...
13. Что для вас эстетика? И что вы решили поменять в своём образе после прочтения раздела?
