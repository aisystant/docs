---
title: "3.3. Важное, текущее и срочное"
order: 3
type: text
---
...
Когда что-то появляется в течение дня, то это не становится сразу Срочной работой[^318]. Каждое новое действие (идея о незапланированном деле) проверяется: может ли она подождать до следующей сессии стратегирования и планирования? Если может подождать, то это действие записывается в мимолетные заметки, а если не может, то записывается в раздел Срочные в трекер Помодоро.
...
Здесь важно не путать срочность с дедлайном. Близкий срок сам по себе не делает задачу срочной: дедлайн может стоять и на текущей работе, и на важной (например, «сдать раздел к пятнице» — это важное с дедлайном, а не срочное). Срочное определяется только угрозой остановки конвейера сейчас, а не приближением срока. Если складывать в «срочное» всё, у чего есть дедлайн, то текучка и сроки вытеснят важное, и развитие остановится.
