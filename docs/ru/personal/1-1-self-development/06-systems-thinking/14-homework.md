...
id: "1.1.06.14"
type: text
title: "6.14. Домашнее задание"
order: 14
---


# 6.14. Домашнее задание
...
3. Потренируйтесь в применении понятий данного раздела, в т.ч. укажите целевые системы, надсистемы, системы создания, системы окружения и подсистемы для следующих ситуаций:
   ...
   - попробуйте определить целевые системы и надсистемы в своих рабочих проектах, а также подумайте, что является делом вашей жизни и какую целевую систему вы сейчас создаёте в своей жизни.

4. Посмотрите фильм «Человек, который изменил всё»: https://www.kinopoisk.ru/film/432791. В процессе просмотра составляйте мимолётные заметки, а потом разберите их в уже имеющиеся черновики и напишите короткую заготовку о самом фильме с учётом изученного раздела. Например, ответьте на вопрос, также используя понятия руководства: что повлияло на успех команды?

5. Если у вас остаётся время на обучение, то прочитайте в руководстве «Практики саморазвития» раздел 6 «Организация досуга».
