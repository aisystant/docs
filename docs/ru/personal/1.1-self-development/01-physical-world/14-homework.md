...
2. Опубликуйте ответы на «Вопросы для повторения и дальнейшего изучения» и свои образовательные заметки обычным списком в клубе МИМ в разделе «Новая грамотность». Если вам сложно публиковать свои размышления, прочитайте этот пост: https://systemsworld.club/t/gordynya-i-drugie-prepyatstviya-v-myshlenii-pismom/11375

3. Не для всех! Если у вас есть время (ещё около 5 часов в неделю) на дополнительное обучение, начните параллельно проходить руководство «Практики саморазвития» и прочтите раздел 1 «О практиках саморазвития и втором мозге».
