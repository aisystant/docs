...
Пока в ШСМ не разработан отдельный курс по эстетике, создателям приходится самостоятельно заботиться о развитии своего эстетического чутья. Это можно делать через:
