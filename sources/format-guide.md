...
### Завершающие файлы раздела

Каждый раздел завершается тремя специальными файлами:

| Файл | Заголовок | Описание |
|------|-----------|----------|
| `XX-concepts.md` | `X.XX. Моделирование: понятия` | Упражнение на выписывание ключевых понятий раздела |
| `XX-review.md` | `X.XX. Вопросы для повторения и дальнейшего изучения` | Контрольные вопросы по материалу раздела |
| `XX-homework.md` | `X.XX. Домашнее задание` | Практические задания для закрепления материала |

**Нумерация:**
- `X` — номер раздела (1, 2, 3...)
- `XX` — порядковый номер файла внутри раздела

Например, для раздела `04-system-psychology`:
- `12-concepts.md` → заголовок `# 4.12. Моделирование: понятия`
- `13-review.md` → заголовок `# 4.13. Вопросы для повторения и дальнейшего изучения`
- `14-homework.md` → заголовок `# 4.14. Домашнее задание`
