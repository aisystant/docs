...
### Практические подразделы

В разделах встречаются специальные подразделы с практическими заданиями для стажёров. Они могут располагаться в любом месте раздела (не обязательно в конце).

#### Типы практических подразделов

**1. Таблицы** — стажёр заполняет ячейки таблицы своими ответами.
- Названия подразделов: «Моделирование», «Моделирование: понятия», «Моделирование: роли» и т.п.
- Суффиксы файлов: `*-concepts.md`, `*-modeling-*.md`

**2. Чек-листы** — стажёр отмечает пункты и при необходимости пишет комментарий.
- Названия подразделов: «Вопросы для повторения», «Домашнее задание», «Задания», «Чек-лист» и т.п.
- Суффиксы файлов: `*-review.md`, `*-homework.md`, `*-checklist-*.md`, `*-tasks.md`

**3. Множественный выбор** — стажёр выбирает правильный ответ из нескольких вариантов и обязательно обосновывает свой выбор текстом.
- Названия подразделов: «Задачи», «Вопросы»
- Суффиксы файлов: `*-questions-*.md`, `*-problems-*.md`

| Тип | Названия подразделов | Суффиксы файлов |
|-----|---------------------|-----------------|
| Таблицы | Моделирование, Моделирование: понятия | `*-concepts.md`, `*-modeling-*.md` |
| Чек-листы | Вопросы для повторения, Домашнее задание, Задания | `*-review.md`, `*-homework.md`, `*-checklist-*.md` |
| Множественный выбор | Задачи, Вопросы | `*-questions-*.md`, `*-problems-*.md` |
...
- Формат: `X.XX.` где `X` — номер раздела, `XX` — порядковый номер файла
- Пример: файл `12-concepts.md` в разделе `04-system-psychology` → заголовок `# 4.12. Моделирование: понятия`

**Примеры:**
```
05-modeling-roles.md      → 4.5. Моделирование: роли       (таблицы)
08-problems-systems.md    → 4.8. Задачи: системы           (множественный выбор)
12-concepts.md            → 4.12. Моделирование: понятия   (таблицы)
13-review.md              → 4.13. Вопросы для повторения   (чек-лист)
14-homework.md            → 4.14. Домашнее задание         (чек-лист)
```
