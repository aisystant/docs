...
## Подраздел (H2) - для подразделов внутри документа
...
- Заголовки используются последовательно без пропусков: H1 → H2 → H3 → H4
- Не пропускайте уровни (например, не используйте H3 сразу после H1)
