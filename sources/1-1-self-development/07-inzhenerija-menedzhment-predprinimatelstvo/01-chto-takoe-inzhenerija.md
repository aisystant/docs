...
[[Основные понятия]{.mark}:]{.underline} инженерия, система, метод, трансдисциплина, деятельность, создатель системы, принципы инженерии, безмасштабность и непрерывность.
...
Понимание принципов инженерии также обязательно используется в саморазвитии личности. В частности, они формируют культуру обучения и корпоративную культуру, что помогает создавать в условиях техноэволюции[^505] такие конкурентоспособные системы, как личность и команда.
