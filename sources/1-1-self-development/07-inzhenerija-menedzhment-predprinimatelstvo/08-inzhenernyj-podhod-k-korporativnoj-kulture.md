...
[[Основные понятия]{.mark}:]{.underline} корпоративная культура, современная корпоративная культура или инженерная культура или инженерно-корпоративная культура, методы корпоративной культуры.
...
- Формирования кадрового резерва исходя из готовности специалиста по таким характеристикам как агентность, степень жизненного мастерства, стрессоустойчивость.
  ...
  1.  Методы коммуникации: как по содержанию, так и по форме.
...
- Документоцентричные совещания[^525] и обсуждения, которые проводятся преимущественно с понятной повесткой и записанными результатами.

  1.  Методы индивидуальной работы каждого сотрудника предприятия
...
- Использование этики при принятии решений.
  ...
  1.  Методы обучения и саморазвития сотрудников
...
- Расширение агентности за счет развития кругозора и калибра личности.
  ...
  1.  Методы мотивации и признания заслуг
...
- Поддержка индивидуальных увлечений сотрудников, в том числе создание клубов по интересам, предоставление ресурсов для хобби.
  ...
  1.  Методы формирования окружающей среды
...
- Формирование удобной технологической инфраструктуры, в том числе использование современных инструментов для совместной работы и автоматизации процессов.
  ...
  1.  Методы получения обратной связи
...
- Поощрение инициативы и открытого выражения мнений.
  ...
  1.  Методы публичности и позиционирования
