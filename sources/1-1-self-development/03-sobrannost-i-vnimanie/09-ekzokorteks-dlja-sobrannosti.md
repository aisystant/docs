...
[[Основные понятия:]{.underline} экзокортекс, управление вниманием, цифровая перегрузка, планирование задач, фильтрация информации, временные масштабы внимания, интеграция технологий, базы знаний, стратегирование, адаптация к изменениям.]{.mark}
...
- В моменте: удержание внимания на конкретной задаче, исключение непродуктивных источников информации[^329],

- На часах и днях: планирование и последовательное выполнение задач, фильтрация нерелевантной информации, ведение базы знаний[^330].
