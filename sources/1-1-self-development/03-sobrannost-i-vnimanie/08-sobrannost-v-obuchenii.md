...
[[Основные понятия]{.underline}: удержание внимания, методы обучения, управление ограниченными ресурсами, практики саморазвития, временные масштабы обучения, стратегирование и планирование, системное мышление.]{.mark}
...
3.  Сознательно выбирать методы обучения[^327], которые соответствуют целям и текущим задачам.
