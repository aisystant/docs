...
[Основные понятия]{.underline}: приемы мышления, системные навыки, понятия системного мышления.
