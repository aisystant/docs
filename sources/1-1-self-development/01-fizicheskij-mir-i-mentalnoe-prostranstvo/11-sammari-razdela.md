...
Мозг -- это физический объект, физическая часть человека, а мышление -- функция мозга, которая формирует мысли и приводит к действиям. Интеллект или мыслительное мастерство -- одна из функций мозга[^148], а поведение интеллекта -- это мышление (вычисления), которое отвечает за разработку гипотез по решениям новых проблем, научение новому мастерству и повышение уровня мастерства, которым уже владеешь.
