...
[[Основные понятия:]{.underline} картина мира, научные и ненаучные картины мира, вероятность предсказания, теория, дисциплина, модель, описание, SoTA, культура.]{.mark}

**[Связь ментального пространства и физического мира]{.mark}**
...
[У современного в]{.mark}зрослого человека, как правило, сформированы стабильные взгляды на мир, но он продолжает в течение всей жизни обновлять и достраивать личную картину мира. Какими элементами он ее обновляет и достраивает? Описаниями частей физического мира и ментального пространства.

Например, географическая карта -- это модель или описание какой-то территории[^16], а сама территория существует в реальном, физическом мире -- по ней можно походить, попрыгать, проложить маршрут и прийти в нужное место. Человек обновляет и расширяет свою картину мира либо самостоятельно -- исследуя территорию, либо получая сведения от других -- карту территории, либо [получая знания о том, как создавать географические карты. Все, что человек познает самостоятельно, получает от других людей и запоминает -- это объекты ментального пространства.]{.mark}
...
![Изображение выглядит как текст, диаграмма, линия, снимок экрана](assets/fig-02.png)
...
![Изображение выглядит как текст, снимок экрана, Мультимедийное программное обеспечение](assets/fig-03.png)
...
![Изображение выглядит как текст, снимок экрана, Шрифт, линия](assets/fig-04.png)
...
![Изображение выглядит как рисунок, зарисовка, графическая вставка, Штриховая графика](assets/fig-05.png)
