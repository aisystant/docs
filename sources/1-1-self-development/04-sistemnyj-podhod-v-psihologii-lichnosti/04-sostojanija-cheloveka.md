...
[[Основные понятия:]{.underline} состояния системы, состояния человека,]{.mark} характеристики системы, ролевое состояние (роль), психологическое состояние, эмоциональное состояние, физическое состояние, переходы между состояниями, системы создания.
...
И еще множество других вариантов состояния[^355]. При этом мы можем также рассматривать ролевое состояние камня. Например, он может в разные моменты времени играть роль «молотка» или роль «пресс-папье».
