...
[[Основные понятия:]{.underline}]{.mark} впечатления, воспоминания, убеждения, память, эмоции, внимание.
...
Когда мы обращаемся к воспоминаниям, наш мозг активирует сложные нейронные сети, отвечающие за хранение информации. Этот процесс напоминает запуск программы на компьютере[^363]: данные могут быть сохранены в памяти компьютера, но для их использования требуется специальная активация.
...
Убеждения можно представить как перечень знаний и оценок, которые направляют наш выбор и последующее поведение. Интеллект использует эти убеждения (они являются его основой) для анализа ситуации и принятия решений. Источниками таких убеждений могут быть как трансдисциплинарные знания[^365] из различных областей науки и культуры, так и личный опыт столкновения с новыми ситуациями.
