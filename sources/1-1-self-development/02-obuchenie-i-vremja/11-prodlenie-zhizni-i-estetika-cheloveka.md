...
[Основные понятия]{.underline}: тело, долголетие, здоровье, сон, техобслуживание организма, эстетика.
...
Создателю необязательно самому становиться врачом или стилистом, но он должен стать квалифицированным заказчиком определенных услуг, а также он должен перенять определенные культурные методы по уходу за собой. Например, регулярный чек-ап организма (об этом в следующем подразделе) и правильный сон. Качество сна претендует на главный интегральный показатель качества жизни. Спокойно спишь, то с большой вероятностью у тебя всё в жизни хорошо[^307]. Может это касается не всех, но для деятельных людей сон особенно важен.
...
Тело можно рассматривать как биологическую систему, и как к любой системе мы можем выделить методы, которые связаны с планированием, созданием или развитием, эксплуатацией (мониторингом, ремонтом, апрегрейдом[^308]) и выводом из эксплуатации.
