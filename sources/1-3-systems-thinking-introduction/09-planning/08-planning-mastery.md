...
+=================================================================================+==========================================+===========================================================================================+
| 1\. Список неудовлетворенностей                                                 | 1\. Список моих затруднений по практике  | 1\. Перечень задач и план работ на определенный горизонт планирования (неделю и/или день) |
|                                                                                 |                                          |                                                                                           |
| 2\. Заметки (что надо сделать тогда-то или вообще)                              | 2\. Мой распорядок дня                   | 2\. Календарь со слотами времени                                                          |
|                                                                                 |                                          |                                                                                           |
| 3\. Список приоритетных проектов и перечень задач по ним                        | 3\. Список имеющихся ресурсов            | 3\. Бюджет времени                                                                        |
|                                                                                 |                                          |                                                                                           |
| 4\. Аналитика по учтенному времени                                              | 4\. Мои роли                             | 4\. Список для крошек времени                                                             |
|                                                                                 |                                          |                                                                                           |
| 5\. Поручения от других лиц или свои идеи, которые появляются в текущем моменте | ...                                      | 5\. Мастерство планирования (новые нейронные связи)                                       |
|                                                                                 |                                          |                                                                                           |
| ...                                                                             |                                          |                                                                                           |
+---------------------------------------------------------------------------------+------------------------------------------+-------------------------------------------------------------------------------------------+
